...
const KcbTransactions = () => {
    ...
    const totalIncome = kcbTransactions.reduce((total, transaction) => {
        return transaction.type === 'income' ? total + transaction.amount : total;
    }, 0);

    const totalExpenses = kcbTransactions.reduce((total, transaction) => {
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.section}>
                <TouchableOpacity
                    onPress={handleImportKCBTransactions}
            ...
            <View style={styles.transactionsContainer}>
                <View style={styles.transactionsHeader}>
                    ...
                    <View style={styles.badge}>
                        <Text style={styles.badgeText}>{kcbTransactions.length}</Text>
                    </View>
                </View>

                {kcbTransactions.length === 0 ? (
...
export default KcbTransactions
